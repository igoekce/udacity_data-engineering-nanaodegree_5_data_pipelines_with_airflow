...
#Connections to be set in Airflow

'''
from airflow.models import Variable
s3_bucket = Variable.set('s3_bucket', 'udacity-dend')
s3_song_key = Variable.set('s3_song_key', 'song_data')
s3_log_key = Variable.set('s3_log_key', 'log_data')
s3_log_json_path_key = Variable.set('s3_log_json_path_key', 'log_json_path.json')
'''

# AWS_KEY = os.environ.get('AWS_KEY')
# AWS_SECRET = os.environ.get('AWS_SECRET')

#guidelines given by project as default parameters
default_args = {
    'owner': 'udacity',
...
dag = DAG('udac_example_dag',
          ...
          description='Load and transform data to Redshift with Airflow',
          schedule_interval='0 * * * *'
        )

# Variables to be added to Airflow in admin section
...
# with help from https://github.com/i3li/data-pipelines-with-airflow